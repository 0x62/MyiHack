chrome.extension.sendMessage({}, function(response) {
	...
	if (document.readyState === "complete") {
		...
		/* Check for jQuery */
		if(!jQuery || !Mousetrap){
			alert("For some reason one of the script files this extension needs couldn't be loaded. Try reinstalling it.");
		}
		
		/* Add the credits message */
		$("body").append("<div class=\"hacked\" id=\"hacked\">" + new Date() + "</div>");
		...
		Mousetrap.bind('command+shift+k', function(e) {
			...
			if(!vis){
			    $("#hacked").html("Plugin by <a href=\"http://www.ovalbit.com\" target=\"_blank\">Benedict Lewis</a> [<a href=\"http://www.ovalbit.com/myimaths-is-easy-or-why-you-shouldnt-validate-client-side/\" target=\"_blank\">?</a>] [<a href=\"#\" id=\"close\">X</a>]");
				...
				/* Update vis variable so hotkey can be used to toggle */
				vis = true;
			}else{
				$(".answers").remove();
				$("#hacked").html(new Date());
